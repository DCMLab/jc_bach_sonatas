...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/jc_bach_sonatas.git
...
* `Johann Christian Bach – Keyboard Sonatas <https://github.com/DCMLab/jc_bach_sonatas/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first movement of the first sonata op. 5 no. 1 has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/wa01op05no1a_Allegretto.tsv')
   notes = ms3.load_tsv('notes/wa01op05no1a_Allegretto.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/jc_bach_sonatas/issues>`__ and feel free to fork and submit pull requests.
